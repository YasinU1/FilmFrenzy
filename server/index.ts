...
const requestOptionsAddCustomers: RequestInit = {
  method: 'POST',
  headers: myHeaders,
  body: raw,
  redirect: 'follow'
  ...
  app.get('/addusers', (req, res) => {
    fetch("https://data.mongodb-api.com/app/data-afuuc/endpoint/data/v1/action/insertOne", requestOptionsAddCustomers)
    .then(res => res.json())
        .then(data => {
            res.json(data)
        })
